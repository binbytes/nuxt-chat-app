<template>
  <div class="chat border rounded bg-white" v-if="recipient">
  ...
  <div class="h-full flex justify-center items-center bg-white" v-else>
    <h3>Please select to start conversation</h3>
  </div>
</template>
